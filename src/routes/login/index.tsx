    ...
    <>
      <div class="flex h-screen w-full">
        ...
        <div class="flex w-1/2 flex-col items-center justify-center bg-sage-green">
          <div class="bg-light-green flex h-3/5 w-3/5 flex-col rounded-md">
            <div class="flex p-8">
              <div
                class="flex justify-center items-center h-4 w-[10%] transform transition duration-500 hover:scale-105 hover:cursor-pointer"
                onClick$={() => (loc.prevUrl ? window.history.back() : nav("/"))}
              >
                <BackArrow />
              </div>
              <div class="flex justify-end items-center h-4 w-full">
                <Logo class="w-[50px]" />
              </div>
            </div>
